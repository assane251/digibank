...
public class CarteBancaireCreditCardController {
    @FXML private JFXTextField numeroCarteField, cvvField, dateExpirationField, soldeField, statutField, codePinField;
    @FXML private JFXButton demanderCarteButton, bloquerCarteButton, debloquerCarteButton;
    @FXML private Text messageText;
    @FXML private Text compteNumero;
    @FXML private JFXTextField montantField, tauxField, dureeField, mensualiteField, tauxInteretField, statutCreditField;
